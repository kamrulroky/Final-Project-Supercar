...
<div class="header">
		...
		<img style= width="400" height="290" src="audi1/audi_r8_v12-1600x1200.jpg"/>
		<img style= width="400" height="290" src="audi1/r8080016_large.jpg"/>
		<p style=""><b>AUDI-R8 V12 LMS</b></p>
		<!--Cars-->
		<?php
	 ...
	 $query="SELECT * FROM cars WHERE carmodelName='Audi R8 V12 LMS'";
...
while($result=mysqli_fetch_array($resource))
	...
	echo "<tr><td>".$result[0]."</td><td>".$result[1]."</td><td>".$result[2]."</td><td>".$result[3]."</td><td>".$result[4]."</td></tr>";
	 ...
	 mysqli_select_db($link,"supercar") or die ("Cannot select the database!");
	 $query="SELECT * FROM car_configuration WHERE car_configuration.carmodelName='Audi R8 V12 LMS'";
...
<br><br><br><br><br><br><br><hr>
		...
		<img style= width="450" height="290" src="audi1/Audi_R8_Spyder_V10_2014_0001.jpg3bff77b5-a02a-4f8b-985d-e63e48ee3775Original.jpg"/>
		<p style=""><b>AUDI-R8 GT SPYDER 2014</b><br>v10</p>
		<!--Cars-->
		<?php
	 ...
	 mysqli_select_db($link,"supercar") or die ("Cannot select the database!");
	 $query="SELECT * FROM cars WHERE carmodelName='R8 GT Spyder'";
...
while($result=mysqli_fetch_array($resource))
	...
	echo "<tr><td>".$result[0]."</td><td>".$result[1]."</td><td>".$result[2]."</td><td>".$result[3]."</td><td>".$result[4]."</td></tr>";
	 ...
	 mysqli_select_db($link,"supercar") or die ("Cannot select the database!");
	 $query="SELECT * FROM car_configuration WHERE car_configuration.carmodelName='R8 GT Spyder'";
...
<br><br><br><br><br><br><br><hr>
		...
		<img style= width="450" height="290" src="audi1/Audi-R8-GT-Wallpapers.jpg"/>
		<p style=""><b>AUDI-R8 GT 2013</b></p>
		<!--Cars-->
		<?php
	 ...
	 mysqli_select_db($link,"supercar") or die ("Cannot select the database!");
	 $query="SELECT * FROM cars WHERE carmodelName='Audi R8 GT(2013'";
...
while($result=mysqli_fetch_array($resource))
	...
	echo "<tr><td>".$result[0]."</td><td>".$result[1]."</td><td>".$result[2]."</td><td>".$result[3]."</td><td>".$result[4]."</td></tr>";
	 ...
	 mysqli_select_db($link,"supercar") or die ("Cannot select the database!");
	 $query="SELECT * FROM car_configuration WHERE car_configuration.carmodelName='Audi R8 GT2013'";
